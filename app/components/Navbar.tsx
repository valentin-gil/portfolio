  ...
  return (
    <>
      <nav className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 w-[calc(100%-3rem)] lg:w-auto" aria-label="Navigation principale">
        <div className="backdrop-blur-sm bg-white/10 dark:bg-black/10 border border-gray-800/30 dark:border-white/30 rounded-full px-6 sm:px-8 lg:px-12 shadow-lg">
